...
```{r}
# create precovid-anxiety dataset from CDC
precovid_anxiety <- data.frame(Symptoms = c("No", "Yes"),
                                Percentage = c(84.4, 15.6))

#write_csv(precovid_anxiety, "precovid_anxiety.csv", append = FALSE)

# create covid-anxiety dataset with calculated mean percentage
covid_anxiety <- data.frame(Symptoms = c("No", "Yes"),
                            Percentage = c(82, 18))

#write_csv(covid_anxiety, "covid_anxiety.csv", append = FALSE)
```
...
# create pre-covid_anxiety bar chart
...
# create covid_anxiety bar chart
