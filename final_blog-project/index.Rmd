...
precovid_anxiety <- read_csv("data/mental-health/precovid_anxiety.csv")
...
covid_anxiety <- read_csv("data/mental-health/covid_anxiety.csv")
...
![](img/final-anxiety-image.jpg){width=100%}
**Percentage of Anxiety** = number of people with anxiety over number of people who took the survey during this week
