...
In order to conduct sentiment analysis we filtered through the tweets to include only tweets containing keywords regarding COVID-19, tokenizing the tweets into single words, and then applying the nrc sentiment database to each word.
...
diff_data <- read_csv("blog-project/data/covid/diff_graph_data.csv")
