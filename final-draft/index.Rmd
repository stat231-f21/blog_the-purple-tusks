...
timeline_graph <- read_csv("data/mental-health/timeline_graph.csv") %>%
...
timeline_graph_up <- read_csv("data/mental-health/timeline_graph.csv") 
...
prc_of_total_sentiment_data <- read_csv2("data/textual/prc_of_total_sentiment_data.csv")
...
sentiment_bar <- read_csv2("data/textual/sent_bar.csv")
...
sentiment_change <- read_csv2("data/textual/sent_final.csv")
